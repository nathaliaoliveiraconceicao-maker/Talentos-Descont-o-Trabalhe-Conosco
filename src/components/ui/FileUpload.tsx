    ...
    <div>
      {!file ? (
        <button
          ...
          className="flex w-full flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50 px-4 py-8 text-center transition-colors hover:border-brand-blue-400 hover:bg-brand-blue-50"
        >
          <Upload className="h-6 w-6 text-brand-blue-600" aria-hidden="true" />
        ...
        <div className="flex items-center justify-between gap-3 rounded-xl border border-brand-blue-300 bg-brand-blue-50 px-4 py-3">
          <div className="flex items-center gap-3 overflow-hidden">
            <FileText className="h-5 w-5 shrink-0 text-brand-blue-700" aria-hidden="true" />
